...
public class AccountPageController extends AbstractSearchPageController
{
	...
	// CMS Pages
	private static final String AWARD_CMS_PAGE = "award";
	private static final String AWARD_DETAILS_CMS_PAGE = "award-details";
	...
	private static final String SHOW_PROFILE_CMS_PAGE = "show-profile";
	...
	@RequestMapping(value = "/show-profile/{customerID}", method = RequestMethod.GET)
	@RequireHardLogIn
	public String showProfile(@PathVariable
	final String customerID, final Model model) throws CMSItemNotFoundException
	{
		final ContentPageModel showProfileCMSPage = getContentPageForLabelOrId(SHOW_PROFILE_CMS_PAGE);
		storeCmsPageInModel(model, showProfileCMSPage);
		setUpMetaDataForContentPage(model, showProfileCMSPage);
